...
namespace FPSDemo.Player
{
    public class EnvironmentScanner : MonoBehaviour
    {
        ...
        public List<ValidHit> ObstacleCheck()
        {
            ...
            var maxRaycastLength = _player.IsGrounded ? _actualRayLengthFromGround : _actualRayLengthFromGroundUngrounded;
            foreach (var forwardHit in _forwardHitPositions)
            {
                ...
                RaycastHit[] raycasts = PhysicsUtils.RaycastTrulyAll(coordXZToCheck, Vector3.down, _obstacleLayer, 0.01f, maxRaycastLength);
