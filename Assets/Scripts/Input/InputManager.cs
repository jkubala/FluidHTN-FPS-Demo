...
namespace FPSDemo.Input
{
    public class InputManager : MonoBehaviour
    {
        public class InputActionNames
        {
            ...
            public const string AdjustStance = "Adjust Stance";
        ...
        [Tooltip("Reverse vertical input for look.")] [SerializeField]
        ...
        public InputAction AdjustStanceInputAction { get; private set; }
        ...
        void Awake()
        {
            ...
            AdjustStanceInputAction = inputActions.FindAction(InputActionNames.AdjustStance);
        ...
        public void SetActiveAllGameplayControls(bool value)
        {
            if (value)
            {
                ...
                AdjustStanceInputAction.Enable();
            ...
            else
            {
                ...
                AdjustStanceInputAction.Disable();
        ...
        {
            get { return CrouchInputAction.WasReleasedThisFrame(); }
        }

        public Vector2 ChangeStanceAmount
        {
            get
            {
                if (AdjustStanceInputAction.IsPressed())
